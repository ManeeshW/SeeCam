...
class Camera(object):
    def __init__(self, device_name):
        ...
        qctrl = v4l2.v4l2_queryctrl()
        #brightness
        qctrl.id = v4l2.V4L2_CID_EXPOSURE_AUTO #v4l2.V4L2_CID_EXPOSURE_AUTO # V4L2_CID_EXPOSURE_ABSOLUTE #V4L2_CID_AUTOGAIN
        ioctl(self.fd, v4l2.VIDIOC_QUERYCTRL, qctrl)

        ext_ctrl = v4l2.v4l2_ext_control()
        ext_ctrls = v4l2.v4l2_ext_controls()
        ext_ctrl.id = v4l2.V4L2_CID_EXPOSURE_AUTO
        ...
        self.controls["Auto Exposure"] = (ext_ctrl.id, ext_ctrl.value, qctrl.minimum, qctrl.maximum)
        print(self.controls)
