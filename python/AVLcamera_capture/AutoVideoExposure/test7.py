...
class Camera(object):
    def __init__(self, device_name):
        ...
        qctrl = v4l2.v4l2_queryctrl()
        #brightness
        qctrl.id = v4l2.V4L2_CID_EXPOSURE_ABSOLUTE #v4l2.V4L2_CID_EXPOSURE_AUTO # V4L2_CID_EXPOSURE_ABSOLUTE #V4L2_CID_AUTOGAIN
        ioctl(self.fd, v4l2.VIDIOC_QUERYCTRL, qctrl)

        ext_ctrl = v4l2.v4l2_ext_control()
        ext_ctrls = v4l2.v4l2_ext_controls()
        ext_ctrl.id = v4l2.V4L2_CID_EXPOSURE_ABSOLUTE
        ext_ctrls.controls.contents = ext_ctrl
        ext_ctrls.count = 1
        ext_ctrls.ctrl_class = v4l2.V4L2_CTRL_CLASS_CAMERA
        ioctl(self.fd, v4l2.VIDIOC_G_EXT_CTRLS, ext_ctrls)

        self.controls["Exposure"] = (ext_ctrl.id, ext_ctrl.value, qctrl.minimum, qctrl.maximum)
        print(self.controls)
